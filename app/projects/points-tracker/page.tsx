          ...
          <div className="prose prose-gray max-w-none">
            {activeTab === 'privacy' ? (
              <div>
                ...
                <div className="text-gray-600 space-y-4">
                  <p className="font-semibold mb-4">
                    This privacy policy applies to the Points Tracker - The Best app (hereby referred to as &quot;Application&quot;) for mobile devices that was created by Snumps LLC (hereby referred to as &quot;Service Provider&quot;) as a Free service. This service is intended for use &quot;AS IS&quot;.
                  </p>
                  
                  <h3 className="font-semibold text-lg mb-2">Information Collection and Use</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="font-semibold text-lg mb-2">Third Party Access</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="font-semibold text-lg mb-2">Opt-Out Rights</h3>
                  <p className="mb-4">
                    You can stop all collection of information by the Application easily by uninstalling it. You may use the standard uninstall processes as may be available as part of your mobile device or via the mobile application marketplace or network.
                  </p>
                  
                  <h3 className="font-semibold text-lg mb-2">Data Retention Policy</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="font-semibold text-lg mb-2">Your Consent</h3>
                  <p className="mb-4">
                  ...
                  <p className="mb-4">
                    If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at Support@snumps.com.
                  </p>
              ...
              <div>
                ...
                <div className="text-gray-600 space-y-4">
                  <p className="font-semibold mb-4">
                    These terms and conditions apply to the Points Tracker - The Best app (hereby referred to as &quot;Application&quot;) for mobile devices that was created by Snumps LLC (hereby referred to as &quot;Service Provider&quot;) as a Free service.
                  </p>
                  ...
                  <h3 className="font-semibold text-lg mb-2">Changes to These Terms and Conditions</h3>
                  <p className="mb-4">
                    The Service Provider may periodically update their Terms and Conditions. Therefore, you are advised to review this page regularly for any changes. The Service Provider will notify you of any changes by posting the new Terms and Conditions on this page.
                  </p>
                  
                  <p className="mb-4">
                    These terms and conditions are effective as of 2025-10-29
                  </p>
                  
                  <h3 className="font-semibold text-lg mb-2">Contact Us</h3>
                  <p>
                    If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at Support@snumps.com.
                  </p>
                </div>
              </div>
            )}

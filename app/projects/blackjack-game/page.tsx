            ...
            {activeTab === 'privacy' ? (
              <div>
                ...
                <div className="text-gray-600 space-y-4">
                  ...
                  <p>This privacy policy applies to the Blackjack - No Ads app (hereby referred to as "Application") for mobile devices that was created by Snumps LLC (hereby referred to as "Service Provider") as a Freemium service. This service is intended for use "AS IS".</p>
              ...
              <div>
                ...
                <div className="text-gray-600 space-y-4">
                  ...
                  <p>These terms and conditions apply to the Blackjack - No Ads app (hereby referred to as "Application") for mobile devices that was created by Snumps LLC (hereby referred to as "Service Provider") as a Freemium service.</p>

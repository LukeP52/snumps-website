        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              When we do have openings, these are the qualities that matter most to us.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Problem Solvers</h3>
              <p className="text-gray-600 leading-relaxed">
                People who can identify real problems and build elegant solutions that users actually need.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Developers and designers who prioritize user experience and think about how people will actually use our apps.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Team Players</h3>
              <p className="text-gray-600 leading-relaxed">
                People who work well in small teams, communicate clearly, and are excited about our mission.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Quality Focused</h3>
              <p className="text-gray-600 leading-relaxed">
                People who care about writing clean code, creating beautiful designs, and building reliable apps.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Value Conscious</h3>
              <p className="text-gray-600 leading-relaxed">
                People who understand that great apps should be accessible and affordable to everyone.
              </p>
            </div>
          </div>
        </div>
